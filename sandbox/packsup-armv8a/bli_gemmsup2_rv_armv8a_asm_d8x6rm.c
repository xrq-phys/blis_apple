...
#define EXPAND_CASE(M) \
    case ( 1 << 9 | 1 << 8 | M ): \
        bli_dgemmsup2_rv_armv8a_asm_ ## M ## x6r_pack_pack \
            ( m, n, k, \
              alpha, \
              a, rs_a0, cs_a0, \
              b, rs_b0, cs_b0, \
    ...
    case ( 1 << 9 | 0 << 8 | M ): \
        bli_dgemmsup2_rv_armv8a_asm_ ## M ## x6r_pack_nopack \
            ( m, n, k, \
              alpha, \
              a, rs_a0, cs_a0, \
              b, rs_b0, cs_b0, \
    ...
    case ( 0 << 9 | 1 << 8 | M ): \
        bli_dgemmsup2_rv_armv8a_asm_ ## M ## x6r_nopack_pack \
            ( m, n, k, \
              alpha, \
              a, rs_a0, cs_a0, \
              b, rs_b0, cs_b0, \
    ...
    case ( 0 << 9 | 0 << 8 | M ): \
        bli_dgemmsup2_rv_armv8a_asm_ ## M ## x6r_nopack_nopack \
            ( m, n, k, \
              alpha, \
              a, rs_a0, cs_a0, \
              b, rs_b0, cs_b0, \
