...
#define DGEMM_LOAD_BROW_LOC_1(B0,B1,B2) \
 "ld1  {v"#B0".d}[0], [%[b_0]], %[rs_b]  \n\t"

#define DGEMM_LOAD_BROW_LOC_2(B0,B1,B2) \
  DGEMM_LOAD_BROW_LOC_1(B0,B1,B2) \
 "ld1  {v"#B0".d}[1], [%[b_1]], %[rs_b]  \n\t"

#define DGEMM_LOAD_BROW_LOC_3(B0,B1,B2) \
  DGEMM_LOAD_BROW_LOC_2(B0,B1,B2) \
 "ld1  {v"#B1".d}[0], [%[b_2]], %[rs_b]  \n\t"

#define DGEMM_LOAD_BROW_LOC_4(B0,B1,B2) \
  DGEMM_LOAD_BROW_LOC_3(B0,B1,B2) \
 "ld1  {v"#B1".d}[1], [%[b_3]], %[rs_b]  \n\t"

#define DGEMM_LOAD_BROW_LOC_5(B0,B1,B2) \
  DGEMM_LOAD_BROW_LOC_4(B0,B1,B2) \
 "ld1  {v"#B2".d}[0], [%[b_4]], %[rs_b]  \n\t"

#define DGEMM_LOAD_BROW_LOC_6(B0,B1,B2) \
  DGEMM_LOAD_BROW_LOC_5(B0,B1,B2) \
...
void bli_dgemmsup2_cv_armv8a_asm_8x## THISN ##c_ ## PACKA ## _ ## PACKB \
    ( \
     dim_t            m, \
     dim_t            n, \
     dim_t            k, \
...
DGEMM_LOAD_BROW_LOC_ ## THISN (28,29,30) \
" add             %[a], %[a], %[cs_a]             \n\t" \
DGEMM_8X6_MKER_LOOP_LOC(THISN,fmul,24,25,26,27,28,29,30) \
PACKA_STORE_FWD_ ## PACKA (24,25,26,27,%[a_p]) \
PACKB_STORE_FWD_ ## PACKB (28,29,30,%[b_p]) \
\
DGEMM_LOAD_ACOL_LOC(24,25,26,27) \
DGEMM_LOAD_BROW_LOC_ ## THISN (31,28,29) \
" add             %[a], %[a], %[cs_a]             \n\t" \
DGEMM_8X6_MKER_LOOP_LOC(THISN,fmla,24,25,26,27,31,28,29) \
PACKA_STORE_FWD_ ## PACKA (24,25,26,27,%[a_p]) \
PACKB_STORE_FWD_ ## PACKB (31,28,29,%[b_p]) \
\
DGEMM_LOAD_ACOL_LOC(24,25,26,27) \
DGEMM_LOAD_BROW_LOC_ ## THISN (30,31,28) \
" add             %[a], %[a], %[cs_a]             \n\t" \
DGEMM_8X6_MKER_LOOP_LOC(THISN,fmla,24,25,26,27,30,31,28) \
PACKA_STORE_FWD_ ## PACKA (24,25,26,27,%[a_p]) \
PACKB_STORE_FWD_ ## PACKB (30,31,28,%[b_p]) \
\
DGEMM_LOAD_ACOL_LOC(24,25,26,27) \
DGEMM_LOAD_BROW_LOC_ ## THISN (29,30,31) \
" add             %[a], %[a], %[cs_a]             \n\t" \
...
DGEMM_LOAD_BROW_LOC_ ## THISN (28,29,30) \
" add             %[a], %[a], %[cs_a]             \n\t" \
DGEMM_8X6_MKER_LOOP_LOC(THISN,fmla,24,25,26,27,28,29,30) \
PACKA_STORE_FWD_ ## PACKA (24,25,26,27,%[a_p]) \
PACKB_STORE_FWD_ ## PACKB (28,29,30,%[b_p]) \
\
DGEMM_LOAD_ACOL_LOC(24,25,26,27) \
...
#define EXPAND_CASE(N) \
    case ( 1 << 9 | 1 << 8 | N ): \
        bli_dgemmsup2_cv_armv8a_asm_8x ## N ## c_pack_pack \
            ( m, n, k, \
              alpha, \
              a, rs_a0, cs_a0, \
              b, rs_b0, cs_b0, \
    ...
    case ( 1 << 9 | 0 << 8 | N ): \
        bli_dgemmsup2_cv_armv8a_asm_8x ## N ## c_pack_nopack \
            ( m, n, k, \
              alpha, \
              a, rs_a0, cs_a0, \
              b, rs_b0, cs_b0, \
    ...
    case ( 0 << 9 | 1 << 8 | N ): \
        bli_dgemmsup2_cv_armv8a_asm_8x ## N ## c_nopack_pack \
            ( m, n, k, \
              alpha, \
              a, rs_a0, cs_a0, \
              b, rs_b0, cs_b0, \
    ...
    case ( 0 << 9 | 0 << 8 | N ): \
        bli_dgemmsup2_cv_armv8a_asm_8x ## N ## c_nopack_nopack \
            ( m, n, k, \
              alpha, \
              a, rs_a0, cs_a0, \
              b, rs_b0, cs_b0, \
